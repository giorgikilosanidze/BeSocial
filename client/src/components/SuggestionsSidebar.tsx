				...
				<div className="space-y-3">
					<div className="flex items-center justify-between">
						<div className="flex items-center space-x-3">
							<div className="w-10 h-10 rounded-full overflow-hidden">
								<img
									src="https://ui-avatars.com/api/?name=Alex+Turner&background=dc2626&color=fff"
									alt="Alex Turner"
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center space-x-3">
							<div className="w-10 h-10 rounded-full overflow-hidden">
								<img
									src="https://ui-avatars.com/api/?name=Sophie+Miller&background=ea580c&color=fff"
									alt="Sophie Miller"
									className="w-full h-full object-cover"
								/>
							</div>
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center space-x-3">
							<div className="w-10 h-10 rounded-full overflow-hidden">
								<img
									src="https://ui-avatars.com/api/?name=David+Lee&background=0891b2&color=fff"
									alt="David Lee"
									className="w-full h-full object-cover"
								/>
							</div>
